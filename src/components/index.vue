  ...
  export default {
    ...
    methods: {
      ...
      async getArticles(page) {
        ...
        this.wait = true;
        let pageResArticles = await axios.get(`https://newsapi.org/v2/everything?q=single%20page%20application%20OR%20web&language=en&pageSize=100&page=${page}&apiKey=${newsAPIkey.key1}`)
